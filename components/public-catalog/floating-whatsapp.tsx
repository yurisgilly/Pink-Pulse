  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3">
      ...
      >
        ...
        {/* Outer discreet ping ring */}
        <span className="absolute inset-0 rounded-full border border-emerald-400/30 animate-ping opacity-35 pointer-events-none" />

        {/* Minimalist Vector WhatsApp Icon */}
        <svg
          className="w-7 h-7 fill-current text-emerald-400 group-hover:text-white transition-colors duration-200 relative z-10"
          viewBox="0 0 24 24"
        >
